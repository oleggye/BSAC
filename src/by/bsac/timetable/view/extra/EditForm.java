...
public class EditForm extends JDialog {
	...
	private void getGroupsCollection() throws ServiceException {
		...
		int CB_index = this.comboBox.getSelectedIndex(); // передаем index
															...
															// элемента в
															// ComboBox
		groupsCollection = factory.getGroupService().getGroupListByFacultyAndEduLevel(facultiesCollection.get(CB_index),
				this.edu_level);
	...
	private void addOrUpdateSubjects(ActionMode mode) throws ServiceException, ServiceValidationException {
	...
	private void addOrUpdateGroups(ActionMode mode) throws ServiceException, ServiceValidationException {
	...
	private void addOrUpdateLecturers(ActionMode mode) throws ServiceException, ServiceValidationException {
